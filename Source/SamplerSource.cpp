...
void SamplerSource::setSampledSound(const File& audioFile)
{
    ...
    if (reader != nullptr)
    {
        ...
        baseComp->fileInfoLb->setText(audioFile.getFullPathName(), dontSendNotification);
        baseComp->rootSetCb->setSelectedId(10);
    ...
    else
    {
        ...
        baseComp->rootSetCb->setSelectedId(10);
        baseComp->fileInfoLb->setText(String::empty, dontSendNotification);
...
void SamplerSource::loadSound(int rootNote)
{
    if (reader != nullptr)
    {
        ...
        SamplerSound* sampleSound = new SamplerSound ("sampleSound", *reader, notes, rootNote, 0.0, 0.1, 60.0);
